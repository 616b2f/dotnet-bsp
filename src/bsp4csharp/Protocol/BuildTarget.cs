...
namespace bsp4csharp.Protocol
{
    ...
    public record BuildTarget
    {
        ...
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public IReadOnlyCollection<BuildTargetTag> Tags { get; set; } = Array.Empty<BuildTargetTag>();
        ...
        public IReadOnlyCollection<string> LanguageIds { get; set; } = Array.Empty<string>();

        /// <summary>
        /// The direct upstream build target dependencies of this build target
        /// </summary>
        [DataMember(Name = "dependencies")]
        public IReadOnlyCollection<BuildTargetIdentifier> Dependencies { get; set; } = Array.Empty<BuildTargetIdentifier>();
