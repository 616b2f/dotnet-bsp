...
internal class QueueItem<TRequest, TResponse, TRequestContext> : IQueueItem<TRequestContext>
{
    ...
    private readonly IBpLogger _logger;
    ...
    public IBpServices BpServices { get; }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var telemetryService = bpServices.GetRequiredServices<AbstractTelemetryService>().FirstOrDefault();
    ...
    public async Task<TRequestContext?> CreateRequestContextAsync(CancellationToken cancellationToken)
    {
        ...
        var requestContextFactory = BpServices.GetRequiredService<IRequestContextFactory<TRequestContext>>();
