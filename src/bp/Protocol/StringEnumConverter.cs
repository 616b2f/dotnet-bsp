    ...
    where TStringEnumType : IStringEnum
{
    ...
    static StringEnumConverter()
    {
        ...
        {
            throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, BaseProtocolResources.StringEnumMissingConstructor, typeof(TStringEnumType).FullName));
        }
    ...
    public override object? ReadJson(JsonReader reader, Type objectType, object? existingValue, JsonSerializer serializer)
    {
        ...
        throw new JsonSerializationException(string.Format(CultureInfo.InvariantCulture, BaseProtocolResources.StringEnumSerializationError, reader.Value));
    }
